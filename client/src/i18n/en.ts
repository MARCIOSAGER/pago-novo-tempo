    ...
    pillars: {
      P: {
        ...
        questions: [
          ...
          { text: "I clearly know my 5 non-negotiable principles", example: "E.g.: I can list from memory the principles I never negotiate." },
          ...
          { text: "There is consistency between what I preach/say and what I live", example: "E.g.: What I teach others is what I practice daily." },
          { text: "I have not given in to ethical shortcuts in my work or business", example: "E.g.: I don't hide information or make dubious deals to earn more." },
      ...
      A: {
        ...
        questions: [
          ...
          { text: "There is no significant contradiction between who I am and who I appear to be", example: "E.g.: Those who know me closely would confirm who I seem to be from afar." },
      ...
      G: {
        ...
        subgroups: [
          ...
          { label: "Financial Government", startIndex: 7 },
          { label: "Temporal Government", startIndex: 11 },
        ],
        questions: [
          ...
          { text: "I seek God daily as a spiritual discipline", example: "E.g.: I have a fixed time for prayer, Bible reading, or devotionals." },
          ...
          { text: "I can identify and name what I am feeling", example: "E.g.: I recognize when I'm anxious, frustrated, or sad and deal with it." },
          { text: "I do not let fear or anxiety guide my decisions", example: "E.g.: I make decisions based on principles, not insecurities." },
          ...
          { text: "I practice tithing and offerings with joy and regularity", example: "E.g.: I tithe every month without feeling like I'm losing money." },
          { text: "I have an emergency fund or am building one", example: "E.g.: I have at least 3 months of expenses saved up." },
      ...
      O: {
        ...
        subgroups: [
          ...
          { label: "Radical Obedience", startIndex: 3 },
          { label: "Fruit of Obedience", startIndex: 6 },
        ],
        questions: [
          { text: "I obey what is already written (forgiveness, tithing, honesty, love for others)", example: "E.g.: I practice the basics of the Word without needing a 'special revelation'." },
          { text: "I have not been seeking \"prophetic words\" while ignoring basic commandments", example: "E.g.: I don't ask for new direction while disobeying what God already said." },
          ...
          { text: "I can recognize areas where obedience produced visible fruit in my life", example: "E.g.: I can point to concrete blessings that came after acts of obedience." },
