    ...
    pillars: {
      P: {
        ...
        questions: [
          ...
          { text: "There is consistency between my stated values and my concrete choices", example: "E.g.: Those who observe me closely would confirm I live what I say I believe." },
      ...
      A: {
        ...
        questions: [
          ...
          { text: "I am advancing toward the purpose for which I was created", example: "E.g.: Each month I'm closer to the calling God placed on my life." },
        ],
      ...
      O: {
        ...
        questions: [
          ...
          { text: "I have given up something important because God asked — and I don't regret it", example: "E.g.: There was a concrete moment when I obeyed at real cost and saw the fruit." },
