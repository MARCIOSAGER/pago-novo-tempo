  ...
  diagnostico: {
    ...
    pillars: {
      P: {
        ...
        questions: [
          "Mis decisiones diarias son guiadas por mis principios bíblicos",
          "Sé claramente cuáles son mis 5 principios innegociables",
          "Cuando hay presión o conveniencia, mantengo mis principios",
          "Soy íntegro en lo secreto — cuando nadie está viendo",
          "Hay coherencia entre lo que predico/digo y lo que vivo",
          "No he cedido a atajos éticos en mi trabajo o negocios",
          "Mis finanzas reflejan el principio de la mayordomía fiel",
          "Siembro (tiempo, dinero, inversión) antes de cosechar",
        ],
      },
      A: {
        letter: "A",
        ...
        questions: [
          "Tengo una vida de oración consistente e intencional",
          "Escuché la voz de Dios y obedecí en los últimos 30 días",
          "Hay sintonía entre mi vida pública y mi vida espiritual privada",
          "No hay áreas de mi vida que estoy \"escondiendo\" de Dios",
          "Mi relación más cercana está en paz y caminando juntos",
          "No hay conflictos relacionales no resueltos drenando mi energía",
          "Mi familia siente mi presencia — no solo mi provisión",
          "Soy el mismo en casa y en el trabajo / ministerio",
          "Mis acciones reflejan mis valores declarados",
          "No hay contradicción significativa entre quién soy y quién aparento ser",
          "Me siento en paz con las decisiones que he tomado",
          "Estoy viviendo el propósito para el cual fui creado",
        ],
      },
      G: {
        letter: "G",
        ...
        questions: [
          "Tengo una rutina matutina de encuentro con Dios (oración + Palabra)",
          "Mi vida de ayuno es intencional",
          "Guardo el Sábado / descanso como disciplina espiritual",
          "Controlo mis reacciones incluso en situaciones de presión",
          "No cargo resentimientos no resueltos",
          "Sé identificar y nombrar lo que estoy sintiendo",
          "No dejo que el miedo o la ansiedad guíen mis decisiones",
          "Tengo un presupuesto mensual escrito y lo sigo",
          "Estoy libre de deudas o tengo un plan claro para salir de ellas",
          "Practico el diezmo y la ofrenda con alegría y regularidad",
          "Tengo un fondo de emergencia o estoy construyendo uno",
          "Mi agenda refleja mis prioridades reales",
          "Tengo claridad sobre lo que es urgente vs. lo que es importante",
          "Duermo lo suficiente y descanso intencionalmente",
          "Puedo decir \"no\" sin culpa cuando es necesario",
        ],
      },
      O: {
        letter: "O",
        ...
        questions: [
          "Obedezco lo que ya está escrito (perdón, diezmo, honestidad, amor al prójimo)",
          "No he buscado \"palabras proféticas\" mientras ignoro mandamientos básicos",
          "Soy fiel en lo poco — en las responsabilidades cotidianas",
          "Cuando Dios pide algo que no entiendo, obedezco igual",
          "No hay algo que Dios pidió y yo rechacé por miedo o conveniencia",
          "Confío en el carácter de Dios incluso cuando Sus caminos son incomprensibles",
          "Puedo reconocer áreas donde la obediencia generó fruto visible en mi vida",
          "Mi obediencia es motivada por el amor — no por el miedo o la performance",
          "Estoy avanzando consistentemente en el propósito para el cual fui llamado",
        ],
      },
    },
    results: {
