    ...
    pillars: {
      P: {
        ...
        questions: [
          ...
          { text: "Hay coherencia entre mis valores declarados y mis elecciones concretas", example: "Ej: Quien me observa de cerca confirmaría que vivo lo que digo creer." },
      ...
      A: {
        ...
        questions: [
          ...
          { text: "Estoy avanzando hacia el propósito para el cual fui creado", example: "Ej: Cada mes estoy más cerca del llamado que Dios puso en mi vida." },
        ],
      ...
      O: {
        ...
        questions: [
          ...
          { text: "Ya renuncié a algo importante porque Dios lo pidió — y no me arrepentí", example: "Ej: Hubo un momento concreto en que obedecí con costo real y vi el fruto." },
