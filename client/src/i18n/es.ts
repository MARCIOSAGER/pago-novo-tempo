    ...
    pillars: {
      P: {
        ...
        questions: [
          ...
          { text: "Sé claramente cuáles son mis 5 principios innegociables", example: "Ej: Puedo nombrar ahora mismo cuáles son mis principios fundamentales." },
          { text: "Cuando hay presión o conveniencia, mantengo mis principios", example: "Ej: No cambio mi posición solo porque la mayoría piensa diferente." },
          { text: "Soy íntegro en lo secreto — cuando nadie está viendo", example: "Ej: Actúo con la misma honestidad solo que con las cámaras prendidas." },
          { text: "Hay coherencia entre lo que predico/digo y lo que vivo", example: "Ej: Lo que enseño a otros es exactamente lo que practico en mi vida." },
          { text: "No he cedido a atajos éticos en mi trabajo o negocios", example: "Ej: Nunca miento sobre un producto/servicio para cerrar una venta." },
      ...
      A: {
        ...
        questions: [
          ...
          { text: "Mis acciones reflejan mis valores declarados", example: "Ej: Si digo que la familia es prioridad, mi agenda lo demuestra." },
          { text: "No hay contradicción significativa entre quién soy y quién aparento ser", example: "Ej: Quien me conoce de cerca confirma lo que presento públicamente." },
      ...
      G: {
        ...
        subgroups: [
          ...
          { label: "Gobierno Financiero", startIndex: 7 },
          { label: "Gobierno Temporal", startIndex: 11 },
        ],
        questions: [
          ...
          { text: "Busco a Dios diariamente como disciplina espiritual", example: "Ej: Tengo un horario fijo para oración, lectura bíblica o devocionales." },
          ...
          { text: "Sé identificar y nombrar lo que estoy sintiendo", example: "Ej: Reconozco cuando estoy ansioso, frustrado o triste y lo enfrento." },
          { text: "No dejo que el miedo o la ansiedad guíen mis decisiones", example: "Ej: Tomo decisiones basado en principios, no en inseguridades." },
          ...
          { text: "Practico el diezmo y la ofrenda con alegría y regularidad", example: "Ej: Diezmo cada mes sin pensar que estoy perdiendo dinero." },
          { text: "Tengo un fondo de emergencia o estoy construyendo uno", example: "Ej: Tengo al menos 3 meses de gastos guardados." },
      ...
      O: {
        ...
        subgroups: [
          ...
          { label: "Obediencia Radical", startIndex: 3 },
          { label: "Fruto de la Obediencia", startIndex: 6 },
        ],
        questions: [
          { text: "Obedezco lo que ya está escrito (perdón, diezmo, honestidad, amor al prójimo)", example: "Ej: Practico lo básico de la Palabra sin necesitar una 'revelación especial'." },
          { text: "No he buscado \"palabras proféticas\" mientras ignoro mandamientos básicos", example: "Ej: No pido dirección nueva mientras desobedezco lo que Dios ya dijo." },
          ...
          { text: "Puedo reconocer áreas donde la obediencia generó fruto visible en mi vida", example: "Ej: Puedo señalar bendiciones concretas que vinieron tras actos de obediencia." },
