  ...
  diagnostico: {
    ...
    results: {
      ...
      cta: {
        ...
        titleLine1: "¿Estás listo para",
        titleLine2: "reorganizar tu vida?",
        description: "Este diagnóstico es el comienzo. En la Mentoría Intensiva P.A.G.O., profundizarás cada pilar con acompañamiento personalizado.",
        benefit1: "Acompañamiento personalizado con la metodología P.A.G.O.",
        benefit2: "Kit completo: Biblia RVR, Cuaderno de Estudios, Bolígrafo y Ebook",
        benefit3: "Ejercicios prácticos y reflexiones bíblicas para cada pilar",
        benefit4: "Comunidad de personas en transformación",
