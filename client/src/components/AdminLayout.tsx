      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <Button
            ...
            size="lg"
            className="w-full shadow-lg hover:shadow-xl transition-all font-accent"
          >
            Entrar
          </Button>
          <Link href="/">
            <Button variant="ghost" size="sm" className="gap-2 font-accent text-xs">
          ...
          <SidebarContent className="gap-0">
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    <SidebarMenuButton
                      ...
                      tooltip={item.label}
                      className="h-10 transition-all font-accent text-sm"
                    >
                      <item.icon
            ...
            <div className="px-2 mt-4">
              <SidebarMenuButton
                ...
                className="h-10 transition-all font-accent text-sm text-muted-foreground"
              >
              ...
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 rounded-lg px-1 py-1 hover:bg-accent/50 transition-colors w-full text-left group-data-[collapsible=icon]:justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                  <Avatar className="h-9 w-9 border shrink-0">
                    <AvatarFallback className="text-xs font-medium font-accent">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1">
                  <span className="tracking-tight text-foreground font-accent text-sm">
