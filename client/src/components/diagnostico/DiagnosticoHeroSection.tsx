...
export default function DiagnosticoHeroSection({
  ...
  return (
    <section className="relative min-h-[70vh] flex items-end overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full pt-32 pb-20 lg:pb-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl">
            ...
            <motion.p
              ...
              className="font-body text-lg text-warm-white/80 leading-relaxed max-w-2xl mb-4"
            >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 font-accent text-[10px] uppercase tracking-[0.3em] text-warm-white/50 mb-10"
            >
              <Clock size={12} />
            ...
            {hasSavedState ? (
              <motion.div
                ...
                className="bg-warm-white/5 border border-warm-white/10 p-6 lg:p-8 backdrop-blur-sm"
              >
