        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-3">
            <a
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-[#1A2744] font-[Montserrat] font-semibold text-sm px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors"
            >
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#24292e] text-white font-[Montserrat] font-semibold text-sm px-6 py-3 rounded-lg hover:bg-[#2f363d] transition-colors"
            >
